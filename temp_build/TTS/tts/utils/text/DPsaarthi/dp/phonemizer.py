...
from TTS.tts.utils.text.DPsaarthi.dp import PhonemizerResult
from TTS.tts.utils.text.DPsaarthi.dp.model.model import load_checkpoint
from TTS.tts.utils.text.DPsaarthi.dp.model.predictor import Predictor
from TTS.tts.utils.text.DPsaarthi.dp.utils.logging import get_logger
...
class Phonemizer:
    ...
    def phonemise_list(self,
        ...
        # print('hwhlfwlfh', word_phonemes[subword].item())
        ...
        # print(p.phonemes for p in predictions)
