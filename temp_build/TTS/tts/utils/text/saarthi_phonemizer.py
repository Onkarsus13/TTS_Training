...
ieLex=pd.read_csv('/root/Documents/Audio-Encoder-Pretraining-main/voice_coder/TTS/TTS/tts/utils/text/us_uk_mapped.csv')
ieLexHeads=ieLex['WordHead'].tolist()
ieMapped=ieLex['SaarthiASCII'].tolist()
#odia lexicon
odiaLex=pd.read_csv('/root/Documents/Audio-Encoder-Pretraining-main/voice_coder/TTS/TTS/tts/utils/text/odia_tts_set.csv')
